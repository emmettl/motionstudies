...
**Catalogue status:** terrain-led Carris proof technically promising; exact current feed licence and mode taxonomy require validation, and the full ferry thesis remains incomplete.
