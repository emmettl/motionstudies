...
Hosted verification and catalogue deployment passed at `4c86b50`: [run 34153264962](https://github.com/emmettl/motionstudies/actions/runs/34153264962). The user explicitly approved npm publication on 7 September 2026. The coordinated trusted release passed [verification and publication in run 34155462468](https://github.com/emmettl/motionstudies/actions/runs/34155462468), publishing all four packages with provenance under the `next` tag. Existing consumers remain unchanged until their exact pins are updated.
