...
The approved [private Sites review](https://umlauf-berlin-review.vndh2vk2v4.chatgpt.site) is deployed as version 4 from [Umlauf b1e6ea6](https://github.com/emmettl/umlauf/commit/b1e6ea6306cc1f3e0ccd1a27e8d56258a34559fd). Source/history upload and private deployment were explicitly approved; access is owner-only. The [publication review](https://github.com/emmettl/umlauf/blob/main/docs/REVIEW.md) records source rights and remaining editorial decisions. GitHub Pages remains unavailable under the private repository's current plan; repository visibility was not changed. The title remains provisional and the edition unnumbered.

The approved [public GitHub Pages edition](https://emmettl.github.io/umlauf-pages/) publishes source build `b97f1b1` from [successful checks](https://github.com/emmettl/umlauf/actions/runs/34159579680). The account plan still blocks Pages from a private repository, so the separate [deployment repository](https://github.com/emmettl/umlauf-pages) contains only compiled site assets and approved datasets. The Umlauf source repository and its history remain private. [Pages deployment](https://github.com/emmettl/umlauf-pages/actions/runs/34161660665) succeeded, and all eleven served build files match the CI artifact byte for byte. See the [publication record](https://github.com/emmettl/umlauf/blob/main/docs/PUBLISHING.md).
