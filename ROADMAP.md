...
- [ ] Add a weekday/weekend cycle-hire selector, initially comparing Thursday 28, Friday 29, Saturday 30 and Sunday 31 May 2026 from the already-downloaded 17–31 May extract. Preserve time of day and validated dock selection, label the observed dates, and keep comparison scales consistent. Audit each day’s station identities, exclusions and midnight carry-in/out before shipping separately loaded artifacts; only Friday is compiled today. Available-date evidence and source counts are recorded in All Change’s `docs/CYCLE-HIRE.md`.
...
- [ ] Recover historical coordinates for unmatched/reused dock identities, and audit a matching September journey day when published. Add authored neighbourhood comparisons after the source/coverage checks.
