...
- [ ] Add Territet–Glion terrain playback using a suitably detailed measured landscape, both loop branches as context and a map fallback through the unresolved branch interval; validate standalone and combined journeys in both directions.
