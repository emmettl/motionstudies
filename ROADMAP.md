...
- [ ] Add combined Territet–Glion–Rochers-de-Naye playback using the audited pairs, a shared dated clock and an explicit interchange phase; retain source dwells, seek/replay and operator access context without inventing a walking animation.
- [ ] Investigate measured funicular geometry and other operating dates separately.
