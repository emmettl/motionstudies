...
- [ ] Audit actual railway XYZ geometry and tunnel/covered structures before adding Gornergrat measured outdoor terrain; assess descending authored journeys and further operating dates separately.
- [ ] Assess Pilatus and Rochers-de-Naye as compact follow-camera journeys using the services already found in the national timetable.
...
- [ ] Establish the preceding Thursday TfL rail tail before claiming complete overnight rail gaps; separately audit Friday-night/Saturday service and Thursday NUMBAT demand. Keep physical-phone review separate from browser emulation.
